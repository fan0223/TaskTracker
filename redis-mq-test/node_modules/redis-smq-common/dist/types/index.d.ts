...
import { RedisClientOptions, RedisClientType, RedisFunctions, RedisModules, RedisScripts } from '@redis/client';
export interface IORedisConfig {
    client: RedisClientName.IOREDIS;
    options?: RedisOptions;
}
export declare enum RedisClientName {
    REDIS = "redis",
    IOREDIS = "ioredis",
    REDIS_V4 = "redis_v4"
}
...
export declare type TRedisConfig = IORedisConfig | INodeRedisConfig | INodeRedisV4Config;
export declare type TNodeRedisV4Multi = RedisClientMultiCommandType<RedisModules, RedisFunctions, RedisScripts>;
export declare type TNodeRedisV4Client = RedisClientType<RedisModules, RedisFunctions, RedisScripts>;
...
export declare type TLoggerConfig = {
    enabled: boolean;
