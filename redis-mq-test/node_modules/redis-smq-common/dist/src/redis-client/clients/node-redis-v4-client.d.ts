...
export declare class NodeRedisV4Client extends RedisClient {
    protected client: import("@redis/client").RedisClientType<import("@redis/client").RedisModules, import("@redis/client").RedisFunctions, import("@redis/client").RedisScripts>;
