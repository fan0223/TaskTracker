...
exports.NodeRedisV3Client = void 0;
const redis_client_1 = require("../redis-client");
const redis_1 = require("redis");
const redis_client_error_1 = require("../errors/redis-client.error");
const node_redis_v3_client_multi_1 = require("./node-redis-v3-client-multi");
const patchedEnd = function (flush) {
    if (flush) {
...
class NodeRedisV3Client extends redis_client_1.RedisClient {
    constructor(config = {}) {
        super();
    ...
    multi() {
        return new node_redis_v3_client_multi_1.NodeRedisV3ClientMulti(this.client);
    }
    watch(args, cb) {
    ...
    evalsha(hash, args, cb) {
        ...
        this.client.evalsha(arrHash.concat(arrArgs), (err, reply) => cb(err, reply));
    }
    get(key, cb) {
...
exports.NodeRedisV3Client = NodeRedisV3Client;
//# sourceMappingURL=node-redis-v3-client.js.map